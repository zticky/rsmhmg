...
$php_main_email = "info@rsmhstockholm.se";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		$php_subject = "Meddelande fortsatta årsmötet 2024";
		...
		. 'Tack för att du kontaktar oss.<br/><br/>'
		. '<strong style="color:#f00a77;">Namn:</strong>  ' . $php_name . '<br/>'
		. '<strong style="color:#f00a77;">Email:</strong>  ' . $php_email . '<br/>'
		. '<strong style="color:#f00a77;">Meddelande:</strong>  ' . $php_message . '<br/><br/>'
		. 'Detta är ett konfirmationsmeddelande.'
		. '<br/>'
		. 'Vi kommer att behandla detta så snart som möjligt</div>';
